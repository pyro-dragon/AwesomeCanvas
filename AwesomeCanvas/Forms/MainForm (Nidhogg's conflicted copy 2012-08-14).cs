...
namespace AwesomeCanvas
{
    ...
    public delegate void GUINewPictureCreatedHandler(CanvasWindow window);
    ...
    public partial class MainForm : Form
    {
        ...
        public event GUINewPictureCreatedHandler GUINewPictureCreated;
        // Constructor
        public MainForm()
        {
            InitializeComponent();
  ...
  //          Console.WriteLine("Canvas Got Focus!");
        ...
        //---------------------------------------------------------------------
        // Return the layer control form
        //---------------------------------------------------------------------
        internal LayerControlForm GetLayerControlForm() 
        {
            return layerControlForm;
        }
    }
}
